...
def fetch_live_gift_nifty(nifty_spot: float) -> Dict[str, Any]:
    ...
    Tries Moneycontrol and ET Markets live feeds before falling back to calculation.
    """
    headers = {
    ...
    # Source 1: Moneycontrol Direct Pricefeed for GIFT NIFTY (Symbol: in;NSX)
    try:
    ...
    # Source 2: Moneycontrol Technical Analysis Global Markets API
    try:
    ...
    # Source 3: ET Markets Global Indices API
    try:
